...
// Les admins voient toutes les todos, les users ne voient que les leurs.
...
export async function getAllTodosService(filters, userId, userRole) {
...
export async function getTodosByIdService(id, userId, userRole) {
  const query = { _id: id };
...
export async function createTodosService(todoData, userId) {
...
export async function updateTodosService(id, updateData, userId, userRole) {
  const query = { _id: id };
...
// Supprimer un todo
export async function deleteTodosService(id, userId, userRole) {
  const query = { _id: id };
...
export async function toggleTodoService(id, userId, userRole) {
  const query = { _id: id };
